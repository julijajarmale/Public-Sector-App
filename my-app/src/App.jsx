...
function App() {
  return (
    ...
    <Routes> 
        ...
        <Route path="/admin/municipalities" element={<RequireAuth role="admin"><Back show="municipalities" /></RequireAuth>} />
        <Route path="/admin/sectors" element={<RequireAuth role="admin"><Back show="sectors" /></RequireAuth>} />
    </Routes>
